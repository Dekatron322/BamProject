...
const details = [
  {
    id: 1,
    item: "Biller Name",
    value: "Mal. Mudassir Sunusi Shehu",
  },
  {
    id: 2,
          ...
          >
            ...
            >
              <Image
                ...
                source={require("@/assets/images/fi-sr-home1.png")}
              />
              <Spacer size={8} />
              <Text
                style={[
              ...
              {details.map((payment) => (
                ...
                >
                  ...
                  <View style={{ flexDirection: "row", alignItems: "center" }}>
                    ...
                    {payment.item === "Transaction ID" && (
                      <TouchableOpacity
                        onPress={() => handleCopyId(payment.value)}
                      >
                        <Image
                          style={{ height: 20, width: 20, marginLeft: 4 }} // Added marginLeft for spacing
                          source={require("@/assets/images/CopySimple.png")} // Add your image here
                        />
                      </TouchableOpacity>
                    )}
                  </View>
